...
import (
	...
	configEnv "goes/config"
	infraDb "goes/internal/adapters/infrastructure/db"
	infraObsrv "goes/internal/adapters/infrastructure/observability"
	customerGrpcHandlerPkg "goes/internal/adapters/primary/grpc/implementation/customer"
	"goes/internal/adapters/primary/grpc/server/echo"
	customerDbRepositoryPkg "goes/internal/adapters/secondary/repository/db/implementation/customer"
	"goes/internal/adapters/secondary/repository/db/manager"
	customerServicePkg "goes/internal/adapters/service/implementation/customer"
	"goes/internal/adapters/types"
	"goes/internal/adapters/util"
	"syscall"
